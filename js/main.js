    ...
    function getArticles(searchTerm) {
        $.ajax({
            ...
            success: function(response) {
                ...
                //console.log(response.query.search[0].title); //this is json
...
// on can take many more inputs
    ...
    $("#searchBox").on("keypress", function(event) {
      ...
      //console.log('test'); //whenever whatever you type, cut paste etc it logs your input
      //console.log(event.keyCode); //this listens to your key strokes and logs the key's number
    });
